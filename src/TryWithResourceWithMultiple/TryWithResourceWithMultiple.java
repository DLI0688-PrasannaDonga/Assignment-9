package TryWithResourceWithMultiple;
import java.io.*;

public class TryWithResourceWithMultiple {
        ...
        public static void main(String[] args) {
            File file1 = new File("src/TryWithResourceWithMultiple/file1.txt");
            try{
                if(file1.createNewFile())
                    System.out.println(file1.getName()+" created");
            }catch(IOException e){e.printStackTrace();}

            File file2 = new File("src/TryWithResourceWithMultiple/file2.txt");
            try{
